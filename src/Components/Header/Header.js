          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className={['menu', toggle ? 'toggle-menu' : null]}>
              <div className="header_center">
                ...
                <Nav><NavLink to="buisnes" activeClassName="selected" className="menu_item" > Бизнес </NavLink></Nav>
              ...
              <Nav><NavLink to="cart" activeClassName="selected" className="menu_item" > Корзина </NavLink></Nav>
            </Nav>
          </Navbar.Collapse>
        </Navbar>
      </>
